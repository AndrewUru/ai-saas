...
export default function EmbedSnippet({ widgetScriptUrl }: Props) {
  ...
  return (
    <article className="rounded-3xl border border-slate-800/60 bg-slate-900/60 p-6 shadow-lg shadow-slate-900/40 backdrop-blur">
      ...
      <p className="mt-2 text-sm text-slate-300">
        ...
        It includes your API key and branding configuration.
      </p>
      ...
      <div className="mt-4 rounded-2xl border border-amber-400/20 bg-amber-400/10 p-4 text-xs text-amber-200">
        ...
        Do not paste this script directly inside React components.
        Use the official integration method described in the{" "}
        <Link
          href="/docs/nextjs"
