...
export default function ContactPage() {
  return (
    ...
    <main
      className="min-h-screen bg-[#050505] text-neutral-200 selection:bg-neutral-500/30 selection:text-neutral-200"
      data-oid=".x7xqrj"
    >
      {/* Efecto de luz ambiental superior */}
      <div
        className="fixed inset-0 z-0 pointer-events-none bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-neutral-900/20 via-[#050505]/0 to-transparent"
        data-oid="hmqnhfj"
      />
      ...
      >
        ...
        >
          <div
            className="inline-flex items-center rounded-full border border-neutral-500/20 bg-neutral-500/10 px-3 py-1 text-xs font-medium uppercase tracking-wider text-neutral-400 backdrop-blur-sm"
            data-oid="i9ki1b5"
          >
            Agency Support
          </div>
          ...
          >
            ...
            <span className="text-neutral-400" data-oid="83imacs">
              implementation
            </span>
          </h1>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2" data-oid="360dn-:">
          ...
          <div
            className="group relative overflow-hidden rounded-3xl border border-neutral-800 bg-neutral-900/40 p-8 transition-all duration-300 hover:border-neutral-500/50 hover:bg-neutral-900/60 hover:shadow-2xl hover:shadow-neutral-900/20"
            data-oid="t8fsaf2"
          >
            <div
              className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-neutral-800 text-white group-hover:bg-neutral-500 group-hover:text-black transition-colors"
              data-oid="ybbp-3o"
            >
            ...
            <div className="mt-8" data-oid="0z:zys3">
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-neutral-400 transition-colors hover:text-neutral-300"
                data-oid="l-r2bqw"
              >
                atobio459@gmail.com
                <ArrowRight
          ...
          >
            ...
            <div
              className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-neutral-500/10 blur-3xl transition-all group-hover:bg-neutral-500/20"
              data-oid="fksogu1"
            ></div>
